      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 8, paddingRight: 4 }}>
        {goals.map((goal, i) => {
          ...
          return (
            ...
            >
              <Pressable
                onPress={() => (canEdit && onToggle ? onToggle(i) : onPressGoal(i))}
                onLongPress={canEdit ? () => onPressGoal(i) : undefined}
                ...
                accessibilityLabel={`Goal ${i + 1}: ${goal.goalText || 'empty'}${done ? ', completed' : ''}${
